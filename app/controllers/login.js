...
function login(hostIP, username, password) {
	...
	var xhr = Ti.Network.createHTTPClient({
	    onload: function(e) {
			...
			getCurrentUserDeaRegistrationNumbers(hostIP, username, password);
...
function getCurrentUserDeaRegistrationNumbers(hostIP, username, password){
	var creds = Ti.Utils.base64encode(username+":"+password);
	var KeyId = "aa719fec-a2e9-48e7-9a03-2fab2a5be0b1";
	var url = "http://"+hostIP+":6080/rest/v1/users/security/certificate/private?limit=50&offset=0";
